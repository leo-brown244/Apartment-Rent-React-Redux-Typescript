    ...
    >
      ...
      <DialogContent className={classes.container}>
        <Grid item md={true} sm={true} xs={true} className={classes.rowContainer}>
          <TextField
            label={error[ApartmentFormKeys.name] ? error[ApartmentFormKeys.name] : "Name"}
            type="text"
            fullWidth
            autoFocus
            required
        ...
        <Grid item md={true} sm={true} xs={true} className={classes.rowContainer}>
          <TextField
            label={error[ApartmentFormKeys.description] ? error[ApartmentFormKeys.description] : "Description"}
            type="text"
            fullWidth
            onChange={(event) => {
              const { value } = event.target;
        ...
        <Grid item md={true} sm={true} xs={true} className={classes.rowContainer}>
          <TextField
            label={error[ApartmentFormKeys.size] ? error[ApartmentFormKeys.size] : "Floor Area Size"}
            type="number"
            fullWidth
            required
            onChange={(event) => {
        ...
        <Grid item md={true} sm={true} xs={true} className={classes.rowContainer}>
          <TextField
            label={error[ApartmentFormKeys.price] ? error[ApartmentFormKeys.price] : "Price per month"}
            type="number"
            fullWidth
            required
            onChange={(event) => {
        ...
        <Grid item md={true} sm={true} xs={true} className={classes.rowContainer}>
          <TextField
            label={error[ApartmentFormKeys.roomNums] ? error[ApartmentFormKeys.roomNums] : "Number of rooms"}
            type="number"
            fullWidth
            required
            onChange={(event) => {
