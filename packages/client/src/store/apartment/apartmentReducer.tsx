...
export const apartmentReducer = createReducer<ApartmentReducerType>(defaultState, {
  ...
  [ActionType.APARTMENT_SET_EDIT_DIALOG_OPEN_STATUS]: setEditDialogOpenStatusReducer,
});
